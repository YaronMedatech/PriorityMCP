...
console.log("\n4. list_skills says why, not 'none'");
...
console.log("\n5. readiness carries programs and skills");
const rr = await call("readiness_report", {});
if (rr.totals?.programs > 5000 && typeof rr.totals?.runnablePrograms === "number" && rr.skills) ok(`programs=${rr.totals.programs}, runnable=${rr.totals.runnablePrograms}, skills.available=${rr.skills.available}`);
